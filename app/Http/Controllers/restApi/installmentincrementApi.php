...
use App\Installment_increment;
use Illuminate\Database\QueryException;

class installmentincrementApi extends Controller
{
    /**
    ...
    {
        $this->response = Installment_increment::where("no_of_ins",$data)->get();
